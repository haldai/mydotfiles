...
\\def\\pgfsysdriver{pgfsys-dvisvgm4ht.def}"))
  ...
  (custom-theme-set-faces
   ...
   '(org-level-2 ((t (:family "Vollkorn" :height 1.4 :weight bold))))
   '(org-level-3 ((t (:family "Vollkorn" :height 1.3 :weight bold))))
   '(org-level-4 ((t (:family "Vollkorn" :height 1.2 :weight bold))))
   '(org-level-5 ((t (:family "Vollkorn" :height 1.1 :weight bold))))
   '(org-level-6 ((t (:family "Vollkorn" :height 1.0 :weight bold))))
   '(org-level-7 ((t (:family "Vollkorn" :height 1.0 :weight bold))))
   '(org-level-8 ((t (:family "Vollkorn" :height 1.0 :weight bold))))
   ...
   '(org-document-info ((t (:family "Vollkorn" :slant italic))))
