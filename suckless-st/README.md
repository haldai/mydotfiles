...
This is a modified version from [Luke's build of st - the simple (suckless) terminal](https://github.com/LukeSmithxyz/st)

Some changes has been made:

+ Applied the ime fix patch.
+ Applied the keyboard fix patch.
+ Modified the color converting function in x.c according to the [xst](https://github.com/gnotclub/xst) code.

## Original introduction of Lukes st
...
- Wang-Zhou Dai <dai.wzero@gmail.com>
