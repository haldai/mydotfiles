...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   ;; with 2 themes variaTnts, one dark and one light)
...
before packages are loaded."
  ...
  (org-babel-do-load-languages
   ...
   '((ditaa . t)
     (dot . t)
     (gnuplot . t)))
  ;; org-mode use xelatex for latex export
