...
static char *font = "SauceCodePro Nerd Font:pixelsize=16:antialias=true:autohint=true;FZCuSong-B09:pixelsize=16:antialias=true:autohint=true;FontAwesome:pixelsize=16:antialias=true:autohint=true;";
...
static unsigned int bold_font = 200;
