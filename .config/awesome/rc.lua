...
local myawesomemenu = {
  ...
  { " 設定", string.format("%s -e %s %s", terminal, editor, awesome.conffile),
                                                                                   icon_path ..
    "categories/system-settings.png" },
  { " 重載", awesome.restart,                                                  icon_path .. "actions/system-reboot.png" },
  { " 退出", function() awesome.quit() end,                                    icon_path ..
...
--- Workspace Navigation
  ...
  awful.key({ modkey }, "-", function()
      scratch.drop(terminal, "center", "center", 720, 400)
    end,
  ...
  awful.key({ modkey, "Shift" }, "F3",
    function() awful.spawn("google-chrome-stable --disable-web-security --user-data-dir") end,
  ...
  awful.key({}, "Print", function() awful.spawn("/home/daiwz/.scripts/flameshot-nohidpi full -c -p /home/daiwz/Pictures/Flameshot") end,
    { description = "print full screen", group = "launcher" }),
  awful.key({ modkey }, "Print", function() awful.spawn("/home/daiwz/.scripts/flameshot-nohidpi gui") end,
